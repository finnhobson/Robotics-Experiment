...
volatile long right_count_prior; // 
...
volatile long left_count_prior; // 
...
ISR( INT6_vect ) {
  ...
  switch( state ) {
    ...
    case 1:  right_count--; break;  // clockwise?
    case 2:  right_count++; break;  // anti-clockwise?
    case 3:              break;  // Invalid
    case 4:  right_count++; break;  // anti-clockwise?
    case 5:              break;  // No movement.
    case 6:              break;  // Invalid
    case 7:  right_count--; break;  // clockwise?
    case 8:  right_count--; break;  // clockwise?
    case 9:              break;  // Invalid
    case 10:             break;  // No movement.
    case 11: right_count++; break;  // anti-clockwise?
    case 12:             break;  // Invalid
    case 13: right_count++; break;  // anti-clockwise?
    case 14: right_count--; break;  // clockwise?
...
ISR( PCINT0_vect ) {
  ...
  switch( state ) {
    case 0:  break; // No movement.
    case 1:  left_count--; break;  // clockwise?
    case 2:  left_count++; break;  // anti-clockwise?
    case 3:              break;  // Invalid
    case 4:  left_count++; break;  // anti-clockwise?
    case 5:              break;  // No movement.
    case 6:              break;  // Invalid
    case 7:  left_count--; break;  // clockwise?
    case 8:  left_count--; break;  // clockwise?
    case 9:              break;  // Invalid
    case 10:             break;  // No movement.
    case 11: left_count++; break;  // anti-clockwise?
    case 12:             break;  // Invalid
    case 13: left_count++; break;  // anti-clockwise?
    case 14: left_count--; break;  // clockwise?
    case 15:             break;  // No movement.
  }
